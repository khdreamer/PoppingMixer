...
/// ----------------------
///
/// Copyright � 2009 - 2014. Little Endian Ltd. All rights reserved.
///
////////////////////////////////////////////////////////////////////////////////
//------------------------------------------------------------------------------
...
#define LE_ADD_INDIVIDUAL_PARAMETER_WORKER( index, parameter )                                                         \
    template <int dummy> struct IndexToParameter<index    , dummy> { typedef parameter type; };                        \
    template <int dummy> struct ParameterToIndex<parameter, dummy> : boost::mpl::integral_c<boost::uint8_t, index> {}; \
    parameter & get( parameter * ) { return BOOST_PP_CAT( parameter, _ ); }                                            \
...
#define LE_DEFINE_PARAMETERS( parameters )                                                                     \
    ...
    struct Parameters                                                                                          \
    {                                                                                                          \
        static boost::uint8_t const static_size = BOOST_PP_SEQ_SIZE( parameters );                             \
        ...
        typedef boost::mpl::integral_c<boost::uint8_t, static_size> size      ;                                \
        template <unsigned int   , int dummy = 0> struct IndexToParameter;                                     \
        template <class Parameter, int dummy = 0> struct ParameterToIndex : size {};                           \
