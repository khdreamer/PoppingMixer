...
/// -------------------
///
/// Copyright © 2009 - 2014. Little Endian. All rights reserved.
///
////////////////////////////////////////////////////////////////////////////////
//------------------------------------------------------------------------------
...
public:
    ...
    Parameter( param_type initialValue = ImplTraits::default_() )
    {
...
private:
    // "Invalid range."
    BOOST_STATIC_ASSERT( ImplTraits::unscaledMaximum >= ImplTraits::unscaledMinimum );
